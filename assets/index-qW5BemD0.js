 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(e){e.INTERNAL.registerComponent(new F("auth-compat",e=>{const t=e.getProvider("app-compat").getImmediate(),n=e.getProvider("auth");return new Qb(t,n)},"PUBLIC").setServiceProps({ActionCodeInfo:{Operation:{EMAIL_SIGNIN:zy,PASSWORD_RESET:$y,RECOVER_EMAIL:Ky,REVERT_SECOND_FACTOR_ADDITION:Gy,VERIFY_AND_CHANGE_EMAIL:Hy,VERIFY_EMAIL:Wy}},EmailAuthProvider:qw,FacebookAuthProvider:Kw,GithubAuthProvider:Hw,GoogleAuthProvider:Gw,OAuthProvider:$w,SAMLAuthProvider:Qw,PhoneAuthProvider:Xb,PhoneMultiFactorGenerator:ab,RecaptchaVerifier:eT,TwitterAuthProvider:Jw,Auth:Qb,AuthCredential:Cw,Error:b}).setInstantiationMode("LAZY").setMultipleInstances(!1)),e.registerVersion("@firebase/auth-compat","0.6.4")}(Et);const tT={posts:[],pages:[],categories:[],settings:{sitename:"Taipulme",priorityPostIds:[]},images:[]},nT={apiKey:"AIzaSyDaCVGTacHKbgY-c-AZOEmx5VrwPy1RrG8",authDomain:"taitangau-7c2bb.firebaseapp.com",projectId:"taitangau-7c2bb",storageBucket:"taitangau-7c2bb.firebasestorage.app",messagingSenderId:"211203067163",appId:"1:211203067163:web:049caa517ca10ca0da57be"};let rT=!1,iT=null,sT=null;async function oT(){if(iT)return iT;const e=(async()=>{if(rT)return!0;try{return"undefined"==typeof window||Et.apps.length||Et.initializeApp(nT),n=Et.firestore(),sT=n,window.db=n,t=Et.storage(),window._storage=t,e=Et.auth(),window._auth=e,rT=!0,!0}catch(r){return!1}var e,t,n})();return(e=>{iT=e})(e),e}async function aT(){if(!sT)return!1;try{const r=sT,i=await r.collection("site").doc("settings").get();i.exists&&(n=i.data(),tT.settings={...tT.settings,...n});const s=(await r.collection("categories").get()).docs.map(e=>({_id:e.id,...e.data()}));t=s,tT.categories=t;const o=await r.collection("posts").orderBy("date","desc").get();(e=>{tT.posts=e})(o.docs.map(e=>({_id:e.id,...e.data()})));const a=(await r.collection("pages").get()).docs.map(e=>({_id:e.id,...e.data()}));return e=a,tT.pages=e,!0}catch(r){return!1}var e,t,n}function cT(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function uT(e){return{"Chuyện Nghề":"💻","Chuyện Đời":"🌱","Sáng Tạo":"🎨",Marketing:"📢"}[e]||"📁"}function lT(e="all"){const t=document.getElementById("posts-list");if(!t)return;let n=tT.posts.filter(e=>"draft"!==e.status);"all"!==e&&(n=n.filter(t=>t.category===e)),0!==n.length?t.innerHTML=n.map(e=>`\n    <article class="post-card" onclick="openPost('${e._id}')">\n      ${e.image?`\n        <div class="post-image-wrap">\n          <img class="post-img" src="${e.image}" alt="${cT(e.title)}" loading="lazy">\n        </div>\n      `:""}\n      <div class="post-content">\n        <div class="post-category">${uT(e.category)} ${cT(e.category)}</div>\n        <h3 class="post-title">${cT(e.title)}</h3>\n        <p class="post-excerpt">${cT(e.excerpt||"")}</p>\n        <div class="post-meta">\n          <span>${function(e){if(!e)return"";try{return new Date(e).toLocaleDateString("vi-VN",{day:"2-digit",month:"2-digit",year:"numeric"})}catch(t){return String(e)}}(e.date)}</span>\n          <span class="dot">·</span>\n          <span>${function(e){if(!e)return 1;const t=e.replace(/<[^>]*>/g,"").split(/\s+/).length;return Math.max(1,Math.ceil(t/200))}(e.content)} phút đọc</span>\n        </div>\n      </div>\n    </article>\n  `).join(""):t.innerHTML='<div style="padding:40px;text-align:center;color:#999">Chưa có bài viết nào trong mục này.</div>'}function hT(){const e=window.location.hash.substring(1),t=window.location.pathname.replace(/^\//,"");if(e&&e===tT.settings.cmsSecret)return window.location.hash="",document.getElementById("cms-page").style.display="flex",document.getElementById("blog-home").style.display="none",document.getElementById("post-detail-page").style.display="none",void(document.getElementById("lp-viewer-page").style.display="none");t&&""!==t?t.startsWith("bai-viet/")?t.substring(9):t.startsWith("danh-muc/")&&dT(t.substring(9)):dT()}function dT(e="all"){document.getElementById("blog-home").style.display="block",document.getElementById("post-detail-page").style.display="none",document.getElementById("lp-viewer-page").style.display="none",document.getElementById("cms-page").style.display="none",function(){const e=document.getElementById("hero-section");if(!e)return;const t=tT.posts.find(e=>"draft"!==e.status&&e.featured)||tT.posts.find(e=>"draft"!==e.status);if(!t)return void(e.style.display="none");const n=t.image||"https://placehold.co/1200x600?text=Taipulme";e.style.display="block",e.innerHTML=`\n    <div class="hero-slider-wrap" onclick="openPost('${t._id}')" style="cursor:pointer">\n      <div class="hero-slide active" style="background-image: url('${n}')">\n        <div class="hero-overlay"></div>\n        <div class="hero-inner-overlay">\n          <div class="hero-text-col">\n            <div class="post-category" style="color: #fff; border-bottom: 2px solid #fff; display: inline-block; margin-bottom: 12px;">\n              ${uT(t.category)} ${cT(t.category)}\n            </div>\n            <h1>${cT(t.title)}</h1>\n            <p class="hero-desc">${cT(t.excerpt||"")}</p>\n            <button class="t-btn btn-white">Đọc bài viết</button>\n          </div>\n        </div>\n      </div>\n    </div>\n  `}(),lT(e),function(e,t=!1){const n=document.getElementById("toast");n&&(n.textContent=e,n.style.background=t?"#ef4444":"#1a1a1a",n.classList.add("show"),setTimeout(()=>n.classList.remove("show"),3e3))}(`Đang ở chuyên mục: ${"all"===e?"Tất cả":e}`)}document.addEventListener("DOMContentLoaded",async function(){document.addEventListener("contextmenu",e=>{e.preventDefault()},!1),document.onkeydown=function(e){return 123!==e.keyCode&&(!e.ctrlKey||!e.shiftKey||73!==e.keyCode)&&(!e.ctrlKey||!e.shiftKey||74!==e.keyCode)&&(!e.ctrlKey||85!==e.keyCode)&&(!e.ctrlKey||83!==e.keyCode)&&void 0},function(){const e={isOpen:!1,orientation:void 0},t=(e,t)=>{window.dispatchEvent(new CustomEvent("devtoolschange",{detail:{isOpen:e,orientation:t}}))};setInterval(()=>{const n=window.outerWidth-window.innerWidth>160,r=window.outerHeight-window.innerHeight>160,i=n?"vertical":"horizontal";r&&n||!(window.Firebug&&window.Firebug.chrome&&window.Firebug.chrome.isInitialized||n||r)?(e.isOpen&&t(!1,void 0),e.isOpen=!1,e.orientation=void 0):(e.isOpen&&e.orientation===i||t(!0,i),e.isOpen=!0,e.orientation=i)},500)}(),setInterval(()=>{},1e3),await oT(),await aT(),window.addEventListener("popstate",e=>{e.state?routerApply(e.state):hT()}),hT();const e=document.getElementById("app-loading");e&&(e.style.opacity="0",setTimeout(()=>{e.style.display="none"},500))});
